...
// - Ejecuta la función en la fase "check" del event loop, o sea, al final del ciclo actual, pero después
// de que se ejecuten los I/O callbacks.
...
// Usar muchos `process.nextTick()` puede hacer que el event loop nunca avance, porque siempre se priorizan esas
// funciones. Por eso, úsalo solo cuando sea muy necesario.
